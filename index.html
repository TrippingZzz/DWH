...
<html>
  ...
  <body>
    ...
    <div id="container">
      <div class="center-align">
        ...
        <p>Bot Username:</p><input type="text" id="username" placeholder="Type the Username of the Webhook here * OPTIONAL" value="TrippingZzz">
  ...
  <div id="footer">
    Copyright &copy; <a href="http://github.com/TrippingZzz/">TrippingZzz</a>
  </div>
